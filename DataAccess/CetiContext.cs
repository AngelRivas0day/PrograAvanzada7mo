    ...
    public class CetiContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PuestoEntity>().HasData(
                new PuestoEntity { PuestoId = 1, TrabajadorId = "836", AcademiaId = 1 },
                new PuestoEntity { PuestoId = 2, TrabajadorId = "520", AcademiaId = 1 },
                new PuestoEntity { PuestoId = 3, TrabajadorId = "969", AcademiaId = 1 },
                new PuestoEntity { PuestoId = 4, TrabajadorId = "662", AcademiaId = 1 },
                new PuestoEntity { PuestoId = 5, TrabajadorId = "870", AcademiaId = 1 },
                new PuestoEntity { PuestoId = 6, TrabajadorId = "142", AcademiaId = 2 },
                new PuestoEntity { PuestoId = 7, TrabajadorId = "106", AcademiaId = 2 },
                new PuestoEntity { PuestoId = 8, TrabajadorId = "728", AcademiaId = 2 },
                new PuestoEntity { PuestoId = 9, TrabajadorId = "861", AcademiaId = 2 },
                new PuestoEntity { PuestoId = 10, TrabajadorId = "675", AcademiaId = 2 },
                new PuestoEntity { PuestoId = 11, TrabajadorId = "972", AcademiaId = 3 },
                new PuestoEntity { PuestoId = 12, TrabajadorId = "779", AcademiaId = 3 },
                new PuestoEntity { PuestoId = 13, TrabajadorId = "656", AcademiaId = 3 },
                new PuestoEntity { PuestoId = 14, TrabajadorId = "991", AcademiaId = 3 },
                new PuestoEntity { PuestoId = 15, TrabajadorId = "669", AcademiaId = 3 },
                new PuestoEntity { PuestoId = 16, TrabajadorId = "500", AcademiaId = 3 }
            );
        }
    }
}
